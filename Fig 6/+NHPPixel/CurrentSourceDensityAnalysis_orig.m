classdef CurrentSourceDensityAnalysis_orig < handle
    ...
    methods
        function csd = CurrentSourceDensityAnalysis_orig(tsi, imec, varargin)
            p = inputParser();
            p.parse(varargin{:});
        ...
        function extract_erp_and_compute_csd(csd, args)
            ...
            assignin('base', 'lfp_orig', lfp);
            
            % compute time vector
            dt_ms = 1000 / imec.fsLF;
            tvec_full = lindelta(windowMs(1), dt_ms, csd.ss.nTimepoints)';
